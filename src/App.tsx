...
//     correct: 1,
//     explanation:
//       "Hope you visit and get Insprired again",
//   },
// ];
...

{
    id: "q6",
    question:
      "Who was affectionately known as ‘Mehar Baba’ for his daring operations during the Kashmir operations of 1947–48?",
    options: [
      "Air Commodore Mehar Singh",
      "Air Marshal Minoo Engineer",
      "Group Captain Padmanabha Gautam",
      "Wing Commander Jag Mohan Nath",
    ],
    correct: 1,
    explanation:
      "Air Commodore Mehar Singh, known as ‘Mehar Baba’, led the first air operations into Leh during the 1947–48 Kashmir conflict.",
  },
  {
    id: "q7",
    question:
      "Which officer became the first Indian to travel to space and was awarded the Ashoka Chakra?",
    options: [
      "Wing Commander Rakesh Sharma",
      "Squadron Leader Ajjamada Devayya",
      "Air Marshal Swaroop Krishna Kaul",
      "Group Captain Chandan Singh",
    ],
    correct: 1,
    explanation:
      "Wing Commander Rakesh Sharma became the first Indian in space aboard the Soviet Soyuz T-11 mission in 1984 and received the Ashoka Chakra.",
  },
  {
    id: "q8",
    question:
      "Which war saw Group Captain Chandan Singh plan and execute the daring helicopter assault on Sylhet?",
    options: [
      "1962 Indo-China War",
      "1965 Indo-Pakistan War",
      "1971 Indo-Pakistan War",
    ...
    correct: 3,
    explanation:
      "Group Captain Chandan Singh’s airborne assault on Sylhet was a key helicopter operation during the 1971 Indo-Pakistan War.",
  },
  {
    id: "q9",
    question:
      "Who among the following was awarded the Maha Vir Chakra twice for exceptional bravery?",
    options: [
      "Wing Commander Hrushikesh Moolgavkar",
      "Group Captain Padmanabha Gautam",
      "Air Commodore Cecil Vivian Parker",
      "Air Marshal Harcharan Singh Manget",
    ],
    correct: 2,
    explanation:
      "Group Captain Padmanabha Gautam is one of the rare double recipients of the Maha Vir Chakra, honored in both 1965 and 1971.",
  },
  {
    id: "q10",
    question:
      "What unique architectural feature allows the statue of Flying Officer Sekhon to be illuminated at dawn?",
    options: [
    ...
    correct: 3,
    explanation:
      "Sekhon’s statue faces east, allowing the first rays of the sun to illuminate his face at dawn — symbolizing eternal vigilance.",
  },
  {
    id: "q11",
    question:
      "Which Air Force officer’s heroism was confirmed decades later through enemy records?",
    options: [
      "Squadron Leader Ajjamada Bopayya Devayya",
      "Wing Commander William Goodman",
      "Air Marshal Minoo Engineer",
      "Group Captain Chandan Singh",
    ],
    correct: 1,
    explanation:
      "Squadron Leader Ajjamada Devayya’s gallant last mission in 1965 was confirmed years later through Pakistani records.",
  },
  {
    id: "q12",
    question:
      "Who among these air warriors rose to become the Chief of Air Staff after earning the Maha Vir Chakra?",
    options: [
      "Wing Commander Hrushikesh Moolgavkar",
      "Air Marshal Minoo Engineer",
      "Group Captain Gautam",
      "Air Marshal Swaroop Kaul",
    ],
    correct: 1,
    explanation:
      "Wing Commander Hrushikesh Moolgavkar later became the Chief of Air Staff, continuing his service to the IAF after his valor in 1947.",
  },
  {
    id: "q13",
    question:
      "Which 2017 Ashoka Chakra awardee was part of the Garud Commando Force?",
    options: [
    ...
    correct: 2,
    explanation:
      "Corporal Jyoti Prakash Nirala, of the Garud Commando Force, was posthumously awarded the Ashoka Chakra for his bravery in 2017.",
  },
  {
    id: "q14",
    question:
      "What does the central statue of Flying Officer Sekhon symbolize within the park layout?",
    options: [
      "The power of air superiority",
      "The eternal flame of courage",
      "The heart and spirit of the Air Force",
      "The triumph of technology over adversity",
    ],
    correct: 3,
    explanation:
      "Sekhon’s central statue represents the heart and spirit of the Indian Air Force, embodying valor and eternal vigilance.",
  },
  {
    id: "q15",
    question:
      "Which hero’s famous reply ‘Saare Jahan Se Achha’ became a symbol of national pride?",
    options: [
      "Air Commodore Mehar Singh",
      "Wing Commander Rakesh Sharma",
      "Air Marshal Swaroop Kaul",
    ...
    correct: 2,
    explanation:
      "Wing Commander Rakesh Sharma’s historic response from space, ‘Saare Jahan Se Achha,’ became a timeless symbol of Indian pride.",
  },
